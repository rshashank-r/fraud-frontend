        ...
        <div className={`flex-1 overflow-y-auto ${isMobile ? 'mt-16' : ''}`}>
          ...
          <div className="bg-slate-900/30 backdrop-blur-xl border-b border-slate-800 p-4 md:p-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              {/* Right Side - Notifications Toggle & Balance */}
              <div className="flex items-center gap-3 md:gap-4">
                ...
                {/* Balance Display */}
                <div className="flex items-center gap-3 md:gap-4 bg-slate-900/50 p-3 md:p-4 rounded-xl border border-slate-800">
                  ...
                  <div className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="p-4 md:p-6 space-y-4 md:space-y-6">
            ...
            {/* UNIFIED ACCOUNT SUMMARY CARD */}
            {activeTab === 'overview' && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                {/* Balance Section - Premium Card */}
                <div className="relative group overflow-hidden rounded-2xl p-1 bg-gradient-to-br from-cyan-500/50 to-blue-600/50 shadow-lg hover:shadow-cyan-500/20 transition-all duration-300">
                  <div className="absolute inset-0 bg-slate-950/90 rounded-2xl m-[1px] backdrop-blur-xl" />
                ...
                <div className="relative group overflow-hidden rounded-2xl p-1 bg-gradient-to-br from-emerald-500/50 to-green-600/50 shadow-lg hover:shadow-emerald-500/20 transition-all duration-300">
                  <div className="absolute inset-0 bg-slate-950/90 rounded-2xl m-[1px] backdrop-blur-xl" />
                  <div className="relative p-6 flex flex-col justify-between h-full">
                    <div className="flex items-start justify-between mb-4">
                      <div className={`p-3 rounded-xl border transition-colors ${(user?.trust_score || 0) > 80
                        ...
                        <Shield className={`w-6 h-6 ${(user?.trust_score || 0) > 80 ? 'text-emerald-400' : 'text-yellow-400'}`} />
                      </div>
                      <div className="flex flex-col items-end">
                        <span className={`text-xs font-bold px-2 py-1 rounded border ${(user?.trust_score || 0) > 80
                    ...
                    <div>
                      ...
                      <div className="flex items-baseline gap-1">
                        <h2 className={`text-3xl font-bold ${(user?.trust_score || 0) > 80 ? 'text-white' : 'text-yellow-100'}`}>
                          {user?.trust_score || 0}
                        </h2>
                      ...
                      <div className="w-full bg-slate-800 h-1 mt-3 rounded-full overflow-hidden">
                        <div
                          className={`h-full transition-all duration-1000 ease-out ${(user?.trust_score || 0) > 80 ? 'bg-emerald-500' : 'bg-yellow-500'}`}
                ...
                {/* Account Status Section - Premium Card */}
                <div className={`relative group overflow-hidden rounded-2xl p-1 shadow-lg transition-all duration-300 ${user?.is_locked
                    ? 'bg-gradient-to-br from-red-500/50 to-pink-600/50 hover:shadow-red-500/20'
                    : 'bg-gradient-to-br from-violet-500/50 to-purple-600/50 hover:shadow-violet-500/20'
                  }`}>
                  <div className="absolute inset-0 bg-slate-950/90 rounded-2xl m-[1px] backdrop-blur-xl" />
                  <div className="relative p-6 flex flex-col justify-between h-full">
                    <div className="flex items-start justify-between mb-4">
                      <div className={`p-3 rounded-xl border transition-colors ${user?.is_locked
                      ...
                      <span className={`text-xs font-bold px-2 py-1 rounded border animate-pulse ${user?.is_locked
                          ? 'text-red-400 bg-red-950/50 border-red-800'
                          : 'text-violet-400 bg-violet-950/50 border-violet-800'
                        }`}>
                    ...
                    <div>
                      ...
                      {user?.is_locked ? (
                        <Button
                          ...
                          size="sm"
                          className="mt-3 w-full bg-red-600 hover:bg-red-500 text-white border-0"
                        >
            ...
            {/* RESPONSIVE QUICK ACTIONS - Only on Overview */}
            {activeTab === 'overview' && (
