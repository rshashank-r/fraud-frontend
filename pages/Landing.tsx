  ...
  const features = [
    {
      ...
      description: 'Advanced machine learning protects every transaction in real-time',
      stat: '99.7%',
    ...
    },
    {
      ...
      description: 'Send money instantly with lightning-fast processing',
      stat: '<50ms',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-x-hidden">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        scrolled ? 'bg-slate-900/95 backdrop-blur-lg border-b border-cyan-500/20 shadow-xl' : 'bg-transparent'
      }`}>
      ...
      <section id="features" className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto mb-8 sm:mb-12">
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-8">
              {features.map((feature, i) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl transition-all text-sm sm:text-base ${
                    activeTab === i
                      ? 'bg-gradient-to-r from-cyan-600 to-purple-600 shadow-lg scale-105'
            ...
            <div className="bg-slate-800/50 border border-cyan-500/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12">
              <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
                <div className="flex-shrink-0">
                  <div className="bg-gradient-to-br from-cyan-500 to-purple-600 p-4 sm:p-6 rounded-2xl">
                    {React.createElement(features[activeTab].icon, { className: 'w-12 h-12 sm:w-16 sm:h-16' })}
                  </div>
                </div>
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3">{features[activeTab].title}</h3>
                  <p className="text-base sm:text-lg text-gray-400 mb-4 sm:mb-6">{features[activeTab].description}</p>
                  <div className="inline-flex items-baseline gap-2">
                    <span className="text-3xl sm:text-4xl md:text-5xl font-bold text-cyan-400">{features[activeTab].stat}</span>
                    <span className="text-base sm:text-lg text-gray-400">{features[activeTab].statLabel}</span>
                  </div>
                </div>
              </div>
            </div>
